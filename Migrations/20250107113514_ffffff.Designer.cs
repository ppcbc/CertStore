...
namespace CertStore.Migrations
{
    ...
    [Migration("20250107113514_ffffff")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CertStore.Models.CertExam", b =>
                {
                    b.Property<int>("CertExamId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CertExamId"));
            ...
            modelBuilder.Entity("CertStore.Models.Certificate", b =>
                {
                    b.Property<int>("CertificateKey")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CertStore.Models.Exam", b =>
                {
                    ...
                    b.Property<bool>("IsCorrect2")
                        .HasColumnType("bit");

                    b.Property<bool>("IsCorrect3")
                        .HasColumnType("bit");

                    b.Property<bool>("IsCorrect4")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CertStore.Models.Item", b =>
                {
                    ...
                    b.HasIndex("CertExamId");

                    b.ToTable("Items");
                });

            modelBuilder.Entity("CertStore.Models.UserDetail", b =>
                {
            ...
            modelBuilder.Entity("CertStore.Models.UserStaf", b =>
                {
                    b.Property<int>("UserStafId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserStafId"));

                    b.Property<int>("CertExamId")
                        .HasColumnType("int");

                    b.Property<DateTime>("DateOfBuyCertExam")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DateOfSelectCertExam")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DateOfSendCertExam")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("CertStore.Models.Item", b =>
                {
                    b.HasOne("CertStore.Models.CertExam", "CertExam")
                        .WithMany("ExamQuestions")
                        .HasForeignKey("CertExamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CertExam");
                });
